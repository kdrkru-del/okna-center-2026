...
export const COMPANY_INFO = {
  ...
  slogan: "Окна, балконы и архитектурное остекление во Владивостоке и Приморском крае",
  ...
  additionalPhones: [
    ...
    { display: "+7 (924) 260-63-50", raw: "+79242606350" },
  ...
  offices: [
    {
      city: "Владивосток",
      address: "Перед визитом уточните адрес офиса по телефону",
      addressNote: "г. Владивосток (адрес офиса уточняйте по телефону)",
    ...
    },
    {
      city: "Уссурийск",
      address: "Перед визитом уточните адрес офиса по телефону",
      addressNote: "г. Уссурийск (адрес офиса уточняйте по телефону)",
