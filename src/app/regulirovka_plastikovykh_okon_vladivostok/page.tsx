...
const pageData = PAGES_DATA["regulirovka_plastikovykh_okon_vladivostok"];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: pageData?.canonical || `${COMPANY_INFO.domain}/regulirovka_plastikovykh_okon_vladivostok/`,
