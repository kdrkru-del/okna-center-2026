        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-600 text-base sm:text-lg font-light leading-relaxed">
              В этом разделе собраны подлинные фотографии объектов, выполненных специалистами компании «Окна Центр» во Владивостоке, Уссурийске и по Приморскому краю: от масштабных 25-этажных жилых комплексов и гособъектов до типовых квартир и теплых лоджий под ключ.
            </p>
          </div>
