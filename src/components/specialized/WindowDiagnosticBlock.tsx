    ...
    <div className="rounded-3xl bg-[#070D18] border border-white/10 p-6 sm:p-8 lg:p-10 shadow-2xl">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
        ...
        <div className="text-right">
          <span className="text-xs text-slate-400 block font-mono">Срочный выезд мастера:</span>
          <span className="text-cyan-300 font-mono font-bold text-sm">во все районы Владивостока</span>
        </div>
      </div>
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                ...
                <p className="text-xs text-slate-300 leading-relaxed">{current.cause}</p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-cyan-500/10 border border-cyan-500/20">
                ...
                <p className="text-xs text-slate-200 leading-relaxed">{current.solution}</p>
              </div>
            </div>
          </div>

          <div className="lg:col-span-4 bg-[#0A111E] rounded-xl p-5 border border-cyan-500/30 flex flex-col justify-between h-full">
            <div>
              <span className="text-[10px] font-mono uppercase tracking-widest text-slate-400 block mb-1">
                Рекомендуемая услуга
              </span>
              <span className="text-sm font-bold text-white block mb-3 leading-snug">
                {current.recommendedService}
              </span>

              <div className="p-3 rounded-lg bg-black/40 border border-white/5 mb-4">
                <span className="text-[10px] uppercase font-mono text-slate-400 block">Прайс мастера:</span>
                <span className="text-lg font-bold text-cyan-300 font-mono">{current.priceEstimate}</span>
              </div>
            </div>
            ...
            <a
              ...
              className="w-full py-2.5 px-4 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-lg shadow-cyan-500/20"
            >
