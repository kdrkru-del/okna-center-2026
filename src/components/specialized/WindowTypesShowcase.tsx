      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-xs">
        <div className="lg:col-span-5 relative h-64 sm:h-80 rounded-xl overflow-hidden border border-slate-200">
          ...
          <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
            <span className="px-3 py-1 rounded-full bg-cyan-600 text-white font-bold text-xs">
              {current.sizes}
            </span>
            <span className="px-3 py-1 rounded-full bg-white/90 backdrop-blur-md text-slate-900 text-xs font-bold border border-slate-200">
              {current.priceFrom}
            </span>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
          <div>
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-2xl font-bold text-slate-900 font-heading">{current.name}</h4>
              <span className="text-xs text-cyan-700 font-semibold">{current.sizes}</span>
            </div>
            ...
            <div className="space-y-2">
              <span className="text-xs uppercase tracking-wide text-slate-500 block font-bold">
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <span className="text-2xl font-black text-slate-950 font-heading">{current.priceFrom}</span>
            </div>

            <Link
              href="/zaiavka_na_uslughi_kompanii_oknatsientr"
              className="px-5 py-2.5 rounded-xl bg-slate-950 hover:bg-cyan-600 text-white font-bold text-xs uppercase tracking-wide transition-colors inline-flex items-center gap-2 shadow-sm"
            >
